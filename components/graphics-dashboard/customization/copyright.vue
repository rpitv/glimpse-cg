  ...
  <div>
    ...
    <div class="mt-4">
      <UFormField label="Text" help="The text of the copyright.">
        <UInput v-model="copyright.text" placeholder="Currently Default" />
      </UFormField>
      <ColorPicker v-model="copyright.textColor" label="Text Color" help="The color for the copyright text." />
      <UFormField class="mt-4" label="Name Size" help="Adjust the size of the copyright text.">
        <UInputNumber v-model="copyright.textSize" :step="0.1" :format-options="{
          minimumFractionDigits: 1,
        }" />
      </UFormField>
    </div>
