    ...
    <UCard id="schedule-card">
        ...
        <div v-else>
            ...
            <div class="flex items-center justify-between gap-2">
                <UTooltip :disabled="!!selectedSchool?.preset" text="This school does not have a preset available."
                          :delay-duration="0">
                    <UButton class="mt-2" :disabled="!selectedSchool || !selectedSchool.preset"
                             @click="emit('loadMatchup', selectedSchool?.preset)">
                        Load Matchup
                    </UButton>
                </UTooltip>
