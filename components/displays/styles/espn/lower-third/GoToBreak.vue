<template>
  ...
  >
    <img
      :style="awayTeamLogo"
      :src="goToBreak.awayTeam.logo || awayTeam!.logo"
    >
  </div>
  <div
    class="colors"
    :style="awayTeamSecondaryColor"
  />
  <div
    class="colors"
  ...
  >
    <img
      :style="homeTeamLogo"
      :src="goToBreak.homeTeam.logo || homeTeam!.logo"
    >
  </div>
  <div
    class="colors"
    :style="rightTeamSecondaryColor"
  />
</template>
...
const rightTeamSecondaryColor = computed((): CSSProperties => {
  return {
